...
/* ── TOPBAR ── */
.topbar{
    background:#12131f;border:1px solid #1e2035;border-radius:14px;
...
.tr-time{font-size:18px;font-weight:700;color:#fff;font-variant-numeric:tabular-nums;line-height:1;}
.tr-date{font-size:11px;color:#4b5563;margin-top:3px;}
.tr-brand{font-size:12px;font-weight:700;color:#6c63ff;margin-top:2px;}
.sun{font-size:22px;cursor:pointer;}
...
.wl{flex:1;min-width:300px;}
.wl h2{font-size:26px;font-weight:800;color:#fff;margin-bottom:6px;}
.wl p{font-size:13px;color:#6b7280;margin-bottom:18px;}
.feats{display:flex;gap:24px;flex-wrap:wrap;}
...
.fs{font-size:11px;color:#4b5563;margin-top:1px;}
.clocks{display:flex;gap:10px;flex-shrink:0;}
.cc{
    background:#12131f;border:1px solid #1e2035;
    border-radius:12px;padding:14px 20px;min-width:170px;
}
.cc-top{display:flex;align-items:center;gap:8px;margin-bottom:8px;}
.cc-flag{font-size:16px;}
.cc-z{font-size:10px;font-weight:700;color:#4b5563;text-transform:uppercase;letter-spacing:0.1em;}
.cc-t{font-size:22px;font-weight:700;color:#fff;font-variant-numeric:tabular-nums;line-height:1;}
.cc-d{font-size:11px;color:#4b5563;margin-top:5px;}
...
.uw-title{font-size:16px;font-weight:700;color:#fff;}
.uw-badge{
    font-size:11px;color:#6b7280;background:#0b0c18;
    border:1px solid #1e2035;border-radius:6px;padding:4px 10px;
}
.drop-zone{
    border:2px dashed #2a2b45;border-radius:14px;
    padding:50px 24px 36px;text-align:center;
    background:#0b0c18;margin-bottom:0;position:relative;
}
.drop-cloud-svg{
    width:72px;height:72px;margin:0 auto 18px;display:block;
}
.drop-t1{font-size:20px;font-weight:700;color:#fff;margin-bottom:6px;}
.drop-t2{font-size:13px;color:#6b7280;margin-bottom:4px;}
.drop-t3{font-size:12px;color:#4b5563;margin-bottom:24px;}
.choose-btn{
...
/* Hide default Streamlit uploader UI completely */
...
.subf-wrap:hover{border-color:#2a2b45;}
...
.st2{font-size:11px;color:#6c63ff;margin-top:2px;}
.sarr{font-size:18px;color:#374151;}
...
.stButton>button:disabled{
    background:#1a1b2e!important;color:#374151!important;cursor:not-allowed!important;
}
...
.sec-t2{font-size:11px;color:#4b5563;margin-top:3px;}
...
.streamlit-expanderHeader{
    background:#0b0c18!important;border:1px solid #1e2035!important;
...
<div class="welcome-row">
  <div class="wl">
    ...
    <div class="feats">
      <div class="feat">
        <div class="fi">🔍</div>
        <div><div class="ft">No steps</div><div class="fs">Just upload your file</div></div>
      </div>
      <div class="feat">
        <div class="fi">💻</div>
        <div><div class="ft">No code</div><div class="fs">We handle the rest</div></div>
      </div>
      <div class="feat">
        <div class="fi">⚡</div>
        <div><div class="ft">Instant Excel</div><div class="fs">Download in seconds</div></div>
      </div>
    </div>
  </div>
  <div class="clocks">
    <div class="cc">
      <div class="cc-top"><span class="cc-flag">🇮🇳</span><span class="cc-z">IST</span></div>
      <div class="cc-t" id="ist-t">--:--:--</div>
      <div class="cc-d" id="ist-d">--</div>
    </div>
    <div class="cc">
      <div class="cc-top"><span class="cc-flag">🇫🇯</span><span class="cc-z">FJT</span></div>
      <div class="cc-t" id="fjt-t">--:--:--</div>
      <div class="cc-d" id="fjt-d">--</div>
    </div>
    <div class="cc">
      <div class="cc-top"><span class="cc-flag">🇺🇸</span><span class="cc-z">EST</span></div>
...
<div class="upload-wrap">
  <div class="uw-head">
    <div class="uw-title">Upload PO PDF</div>
    <div class="uw-badge">Max 200MB per file</div>
  </div>
  <div class="drop-zone">
    <svg class="drop-cloud-svg" viewBox="0 0 80 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M60 48H20C11.163 48 4 40.837 4 32C4 23.715 10.37 16.892 18.5 16.1C20.21 9.196 26.503 4 34 4C43.389 4 51 11.611 51 21C51 21.338 50.987 21.673 50.963 22.005C55.92 22.623 60 26.888 60 32C60 32 64 32 64 36C64 42.627 58.627 48 60 48Z" fill="rgba(108,99,255,0.15)" stroke="#6c63ff" stroke-width="2"/>
      <path d="M40 36V52M40 52L34 46M40 52L46 46" stroke="#6c63ff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
    ...
    <label for="file-upload-trigger" class="choose-btn">
      📁 &nbsp; Choose PDF File
    </label>
  </div>
</div>
...
uploaded_files = st.file_uploader(
    ...
    label_visibility="collapsed", key="file-upload-trigger"
)
...
if uploaded_files:
    ...
    border-radius:10px;padding:10px 14px;margin-bottom:12px;font-size:12px;color:#a78bfa;">
    ✅ &nbsp;<strong style="color:#fff">{len(uploaded_files)} file(s) selected:</strong> {names}
    </div>
    """, unsafe_allow_html=True)
