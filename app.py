...
.logo-name{font-size:16px;font-weight:800;color:#ffffff;letter-spacing:0.01em;}
...
.wl h2{font-size:24px;font-weight:800;color:#ffffff;margin-bottom:6px;}
...
.cc{
    background:#13142a;border:1px solid #2a2b55;
    border-radius:12px;padding:12px 16px;min-width:148px;
}
...
.uc-badge{
    font-size:11px;color:#6b7280;background:#0d0e1c;
    border:1px solid #2a2b55;border-radius:6px;padding:4px 10px;
}

/* ── DROP ZONE — styled over Streamlit uploader ── */
...
/* Hide default uploader icon and replace with ours */
...
[data-testid="stFileUploaderDropzoneInstructions"] span:first-child{
    color:#ffffff!important;font-size:18px!important;font-weight:700!important;
}
...
/* Small file upload instruction text */
[data-testid="stFileUploaderDropzone"] small{
    font-size:11px!important;color:#4b5563!important;
}

/* ── FILE SELECTED BAR ── */
.file-selected{
    background:rgba(108,99,255,0.1);border:1px solid rgba(108,99,255,0.25);
    border-radius:10px;padding:10px 14px;font-size:12px;color:#a78bfa;
    margin-top:10px;
}
...
.stTextArea textarea{
    background:#0d0e1c!important;
    border:1.5px solid #2a2b55!important;
...
.stTextArea textarea:focus{border-color:#6c63ff!important;box-shadow:0 0 0 2px rgba(108,99,255,0.15)!important;}
...
.stButton>button:disabled{
    background:#1e2040!important;color:#4b5563!important;cursor:not-allowed!important;
}
...
<div class="welcome-row">
  ...
  <div class="clocks">
    <div class="cc ist">
      <div class="cc-top"><span style="font-size:15px">🇮🇳</span><span class="cc-z">IST</span></div>
      <div class="cc-t" id="ist-t">--:--:--</div>
      <div class="cc-d" id="ist-d">--</div>
    </div>
    <div class="cc fjt">
      <div class="cc-top"><span style="font-size:15px">🇫🇯</span><span class="cc-z">FJT</span></div>
      <div class="cc-t" id="fjt-t">--:--:--</div>
      <div class="cc-d" id="fjt-d">--</div>
    </div>
    <div class="cc est">
      <div class="cc-top"><span style="font-size:15px">🇺🇸</span><span class="cc-z">EST</span></div>
...
# ── UPLOAD CARD — just the drag & drop, no extra header ──
st.markdown("""
...
# ── SUBF — ALWAYS VISIBLE, NO EXPANDER ──
st.markdown("""
