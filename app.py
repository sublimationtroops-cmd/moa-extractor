...
.moa-title { font-size: 26px; font-weight: 800; color: #e8e8f8; margin-bottom: 4px; }
.moa-title em { color: #7b8cf5; font-style: normal; }
.moa-sub { font-family: 'DM Mono', monospace; font-size: 11px; color: #ffffff; line-height: 1.6; }
.stat-box {
    background: #0d0d1a;
...
.stat-num { font-size: 28px; font-weight: 800; color: #7b8cf5; display: block; }
.stat-lbl { font-family: 'DM Mono', monospace; font-size: 10px; color: #9faabf; text-transform: uppercase; letter-spacing: .08em; }
</style>
...
if extract_btn and uploaded_files:
    ...
    st.markdown(f"""
    <div style='background:rgba(62,207,142,0.08);border:1px solid rgba(62,207,142,0.4);
    border-radius:16px;padding:20px 22px;margin:16px 0;'>
    <div style='font-size:18px;font-weight:700;color:#3ecf8e;margin-bottom:14px;text-align:center;'>
