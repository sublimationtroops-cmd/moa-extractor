...
st.set_page_config(page_title="MOA Extractor — Hsenid", page_icon="📋", layout="centered")
...
.logo-sub { font-size:10px; color:#4b5563; margin-top:1px; }
...
.trc-t { font-size:16px; font-weight:700; color:#fff; font-variant-numeric:tabular-nums; line-height:1; }
.trc-d { font-size:10px; color:#4b5563; margin-top:2px; }
.trc-b { font-size:11px; font-weight:600; color:#6c63ff; margin-top:1px; }
.sun { font-size:20px; }

/* ── WELCOME ── */
.welcome {
    background:#12131f; border:1px solid #1e2035; border-radius:16px;
    padding:18px 20px; margin-bottom:14px;
}
.wt { font-size:19px; font-weight:800; color:#fff; margin-bottom:4px; }
.ws { font-size:12px; color:#6b7280; margin-bottom:14px; }
.feats { display:flex; gap:16px; flex-wrap:wrap; margin-bottom:16px; }
...
.cc {
    flex:1; background:#0b0c18; border:1px solid #1e2035;
    border-radius:10px; padding:10px 14px;
}
.cc-top { display:flex; align-items:center; gap:6px; margin-bottom:5px; }
.cc-flag { font-size:13px; }
.cc-z { font-size:9px; font-weight:700; color:#4b5563; text-transform:uppercase; letter-spacing:0.1em; }
.cc-t { font-size:18px; font-weight:700; color:#fff; font-variant-numeric:tabular-nums; line-height:1; }
.cc-d { font-size:10px; color:#4b5563; margin-top:4px; }
...
.uc-badge {
    font-size:10px; color:#4b5563; background:#0b0c18;
    border:1px solid #1e2035; border-radius:6px; padding:3px 9px;
}
.drop {
    border:1.5px dashed #2a2b45; border-radius:12px;
    padding:38px 20px; text-align:center; background:#0b0c18;
    margin-bottom:14px; cursor:pointer;
}
.drop:hover { border-color:#6c63ff; background:rgba(108,99,255,0.03); }
.drop-icon { font-size:42px; display:block; margin-bottom:12px; }
.drop-t1 { font-size:17px; font-weight:700; color:#fff; margin-bottom:4px; }
.drop-t2 { font-size:12px; color:#6b7280; margin-bottom:3px; }
.drop-t3 { font-size:11px; color:#374151; }

/* Streamlit file uploader - hide default UI, show our own */
...
/* SUBF row */
.subf-row {
    background:#0b0c18; border:1px solid #1e2035; border-radius:10px;
    padding:12px 14px; display:flex; align-items:center;
    justify-content:space-between; margin-bottom:12px; cursor:pointer;
}
.subf-row:hover { border-color:#2a2b45; }
...
.st2 { font-size:10px; color:#4b5563; margin-top:1px; }
.sarr { font-size:16px; color:#374151; }
...
.stButton>button:disabled { background:#1a1b2e!important; color:#374151!important; }
...
.sec-t2 { font-size:10px; color:#4b5563; margin-top:2px; }
...
.stDownloadButton>button {
    ...
    font-size:13px!important; font-weight:700!important; color:#0b0c18!important;
...
.streamlit-expanderHeader {
    ...
    border-radius:8px!important; color:#e2e8f0!important; font-size:12px!important;
}
.stTextArea textarea {
    background:#0b0c18!important; border:1px solid #1e2035!important;
...
<div class="topbar">
  ...
  <div class="tr">
    ...
    <div class="tr-clock">
      <div class="trc-t" id="nav-t">--:--:-- --</div>
      <div class="trc-d" id="nav-d">--</div>
      <div class="trc-b">Hsenid</div>
    </div>
    <div class="sun">☀️</div>
  </div>
</div>
...
st.markdown("""
<div class="welcome">
  <div class="wt">Welcome back! 👋</div>
  <div class="ws">Upload your PO PDF and get a formatted Excel file instantly.</div>
  <div class="feats">
...
# ── CLOCK JS — runs in browser for correct real-time ──
components.html("""
<script>
(function(){
